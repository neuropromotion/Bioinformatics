...
PATH_GTEX_COUNTS = "/Users/neuropromotion/Desktop/miRNA/bulk_review/pipeline_python/gtex_preparing/GTEx_miRNA_counts.parquet"
...
SPECIFICITY_LOG_MODE = 'log_of_mean' # 'log_of_mean' | 'mean_of_log'

BINOM_P_THR = 0.05
PADJ_THR = 0.01 # threshold for significant DE
LFC_THR = 1 # threshold for significant DE
LFC_THR_CPM = 1
